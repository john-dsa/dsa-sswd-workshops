...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>DSA SSWD - mySQL Databases - the Dice Game </title>
...
// reset the score table (delete all records in 'correct_guesses' table) when the user clicks(post) the reset button
...
?>
    ...
    <footer>DSA WSSD @ John Botha, 2018</footer>
    </body>
</html>